...
url = f"https://api.geoapify.com/v1/geocode/search?text={
    encoded_one}&apiKey={api}"
url2 = f"https://api.geoapify.com/v1/geocode/search?text={
    encoded_two}&apiKey={api}"
...
print(f"\nThe distance between {one} and {
      two} is approximately {round(distance, 2)} KM. \n")
